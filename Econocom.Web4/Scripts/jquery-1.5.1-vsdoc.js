...
var jQuery = function( selector, context ) {
		...
		///	</summary>
		///	<param name="selector" DeviceType="String">
		///     1: expression - An expression to search with.
		///     &#10;2: html - A string of HTML to create on the fly.
		///     &#10;3: elements - DOM element(s) to be encapsulated by a jQuery object.
		///     &#10;4: callback - The function to execute when the DOM is ready.
		///	</param>
		///	<param name="context" DeviceType="jQuery">
		///     1: context - A DOM Element, Document or jQuery to use as context.
		///	</param>
		///	<returns DeviceType="jQuery" />
...
jQuery.fn = jQuery.prototype = {
	...
	get: function( num ) {
		...
		///     &#10;Part of Core
		///	</summary>
		///	<returns DeviceType="Element" />
		///	<param name="num" DeviceType="Number">
	...
	pushStack: function( elems, name, selector ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="elems" DeviceType="Elements">
	...
	each: function( callback, args ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="callback" DeviceType="Function">
	...
	ready: function( fn ) {
		...
		///	</summary>
		///	<param name="fn" DeviceType="Function">The function to be executed when the DOM is ready.</param>
	...
	slice: function() {
		...
		///	</summary>
		///	<param name="start" DeviceType="Number" integer="true">Where to start the subset (0-based).</param>
		///	<param name="end" optional="true" DeviceType="Number" integer="true">Where to end the subset (not including the end element itself).
		///     &#10;If omitted, ends at the end of the selection</param>
		///	<returns DeviceType="jQuery">The sliced elements</returns>
...
// Give the init function the jQuery protoDeviceType for later instantiation
...
jQuery.extend = jQuery.fn.extend = function() {
	...
	///     &#10;Part of JavaScript
	///	</summary>
	///	<param name="target" DeviceType="Object">
	///     &#10; The object to extend
	///	</param>
	///	<param name="prop1" DeviceType="Object">
	///     &#10; The object that will be merged into the first.
	///	</param>
	///	<param name="propN" DeviceType="Object" optional="true" parameterArray="true">
...
jQuery.extend({
	...
	isFunction: function( obj ) {
		...
		///	</summary>
		///	<param name="obj" DeviceType="Object">The object to check</param>
		///	<returns DeviceType="Boolean">True if the parameter is a function; otherwise false.</returns>
	...
	isArray: Array.isArray || function( obj ) {
		...
		///	</summary>
		///	<param name="obj" DeviceType="Object">Object to test whether or not it is an array.</param>
		///	<returns DeviceType="Boolean">True if the parameter is a function; otherwise false.</returns>
	...
	isPlainObject: function( obj ) {
		...
		///	</summary>
		///	<param name="obj" DeviceType="Object">
		...
		if ( obj.constructor &&
			...
			!hasOwn.call(obj.constructor.prototype, "isProtoDeviceTypeOf") ) {
			return false;
		}
	...
	nodeName: function( elem, name ) {
		...
		///	</summary>
		///	<param name="elem" DeviceType="Element">The element to examine</param>
		///	<param name="name" DeviceType="String">The node name to check</param>
		///	<returns DeviceType="Boolean">True if the specified node name matches the node's DOM node name; otherwise false</returns>
	...
	each: function( object, callback, args ) {
		...
		///	</param>
		///	<param name="fn" DeviceType="Function">
	...
	makeArray: function( array, results ) {
		...
		///	</summary>
		///	<param name="array" DeviceType="Object">Anything to turn into an actual Array</param>
		///	<returns DeviceType="Array" />
		///	<private />
		...
		if ( array != null ) {
			...
			// The extra DeviceTypeof function check is to prevent crashes
	...
	merge: function( first, second ) {
		...
		///	</summary>
		///	<returns DeviceType="Array" />
		///	<param name="first" DeviceType="Array">
		///     &#10; The first array to merge.
		///	</param>
		///	<param name="second" DeviceType="Array">
...
// Populate the class2DeviceType map
...
if ( indexOf ) {
	jQuery.inArray = function( elem, array ) {
		...
		///	<param name="array" DeviceType="Array">The array to look through for the value</param>
		///	<returns DeviceType="Number" integer="true">The 0-based index of the item if it was found, otherwise -1.</returns>
...
(function() {
	...
	//	div.innerHTML = "   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;'>a</a><input DeviceType='checkbox'/>";
	...
	//	script.DeviceType = "text/javascript";
	//	try {
	...
	//	div = document.createElement("div");
	//	div.innerHTML = "<input DeviceType='radio' name='radiotest' checked='checked'/>";
	...
	//	// http://thinkweb2.com/projects/protoDeviceType/detecting-event-support-without-browser-sniffing/
	...
	//			isSupported = DeviceTypeof el[eventName] === "function";
	//		}
	//		el = null;
...
jQuery.extend({
	...
	data: function( elem, name, data ) {
		...
		///	</summary>
		///	<param name="elem" DeviceType="Element">
		///     &#10;The DOM element to associate with the data.
		///	</param>
		///	<param name="name" DeviceType="String">
		///     &#10;A string naming the piece of data to set.
		///	</param>
		///	<param name="value" DeviceType="Object">
		///     &#10;The new data value.
		///	</param>
		///	<returns DeviceType="jQuery" />
...
jQuery.fn.extend({
	data: function( key, value ) {
		...
		///	</summary>
		///	<param name="key" DeviceType="String">
		///     &#10;A string naming the piece of data to set.
		///	</param>
		///	<param name="value" DeviceType="Object">
		///     &#10;The new data value.
...
jQuery.fn.extend({
	queue: function( type, data ) {
		...
		///	</summary>
		///	<param name="DeviceType" DeviceType="Function">The function to add to the queue.</param>
		///	<returns DeviceType="jQuery" />
	...
	dequeue: function( type ) {
		...
		///	</summary>
		///	<param name="DeviceType" DeviceType="String" optional="true">The DeviceType of queue to access.</param>
		///	<returns DeviceType="jQuery" />
	...
	clearQueue: function( type ) {
		...
		///	</summary>
		///	<param name="DeviceType" DeviceType="String" optional="true">
		///     &#10;A string containing the name of the queue. Defaults to fx, the standard effects queue.
		///	</param>
		///	<returns DeviceType="jQuery" />
...
jQuery.fn.extend({
	attr: function( name, value ) {
		...
		///	</param>
		///	<param name="value" DeviceType="Function">
	...
	addClass: function( value ) {
		...
		///     &#10;Part of DOM/Attributes
		///	</summary>
		///	<param name="value" DeviceType="String">
	...
	removeClass: function( value ) {
		...
		///     &#10;Part of DOM/Attributes
		///	</summary>
		///	<param name="value" DeviceType="String" optional="true">
	...
	toggleClass: function( value, stateVal ) {
		...
		///	</param>
		///	<param name="stateVal" DeviceType="Object">
	...
	hasClass: function( selector ) {
		...
		///	</summary>
		///	<param name="selector" DeviceType="String">The class to check against</param>
		///	<returns DeviceType="Boolean">True if at least one element in the selection has the class, otherwise false.</returns>
...
jQuery.extend({
	...
	attr: function( elem, name, value, pass ) {
		...
		if ( (name in elem || elem[ name ] !== undefined) && notxml && !special ) {
			if ( set ) {
				// We can't allow the DeviceType property to be changed (since it causes problems in IE)
				if ( name === "DeviceType" && rtype.test( elem.nodeName ) && elem.parentNode ) {
					jQuery.error( "DeviceType property can't be changed" );
				}
...
jQuery.event = {
	...
	remove: function( elem, types, handler ) {
		...
		// DeviceTypes is actually an event object here
		if ( types && types.type ) {
		...
		while ( (type = types[ i++ ]) ) {
			...
			for ( j = pos || 0; j < eventType.length; j++ ) {
				...
				if ( handler.guid === handleObj.guid ) {
					// remove the given handler for the given DeviceType
					if ( all || namespace.test( handleObj.namespace ) ) {
						if ( pos == null ) {
							eventType.splice( j--, 1 );
						}
	...
	trigger: function( event, data, elem /*, bubbling */ ) {
		...
		// Event object or event DeviceType
		...
		if ( !bubbling ) {
			event = typeof event === "object" ?
				...
				// Just the event DeviceType (string)
				jQuery.Event(type);
		...
		// prevent IE from throwing an error for some elements with some event DeviceTypes, see #3533
		} catch (inlineError) {}
...
var withinElement = function( event ) {
	...
	try {
		...
		if ( parent !== this ) {
			// set the correct event DeviceType
...
// In case of event delegation, we only need to rename the event.DeviceType,
...
//		jQuery.fn[ name ] = function( DeviceType, data, fn ) {
//			// Handle object literals
//			if ( DeviceTypeof DeviceType === "object" ) {
//				for ( var key in DeviceType ) {
//					this[ name ](key, data, DeviceType[key], fn);
//				}
//				return this;
//			}
...
//			if ( DeviceType === "unload" && name !== "one" ) {
//				this.one( DeviceType, data, fn );

//			} else {
//				for ( var i = 0, l = this.length; i < l; i++ ) {
//					jQuery.event.add( this[i], DeviceType, handler, data );
//				}
//			}
...
jQuery.fn[ "bind" ] = function( type, data, fn ) {
	...
	///	</summary>
	///	<param name="DeviceType" DeviceType="String">One or more event DeviceTypes separated by a space.  Built-in event DeviceType values are: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
	///	<param name="data" optional="true" DeviceType="Object">Additional data passed to the event handler as event.data</param>
	///	<param name="fn" DeviceType="Function">A function to bind to the event on each of the set of matched elements.  function callback(eventObject) such that this corresponds to the dom element.</param>
...
jQuery.fn.extend({
	...
	trigger: function( type, data ) {
		///	<summary>
		///     &#10;Triggers a DeviceType of event on every matched element.
		///	</summary>
		///	<param name="DeviceType" DeviceType="String">One or more event DeviceTypes separated by a space.  Built-in event DeviceType values are: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
		///	<param name="data" optional="true" DeviceType="Array">Additional data passed to the event handler as additional arguments.</param>
		///	<param name="fn" DeviceType="Function">This parameter is undocumented.</param>
	...
	triggerHandler: function( type, data ) {
		///	<summary>
		///     &#10;Triggers all bound event handlers on an element for a specific event DeviceType without executing the browser's default actions.
		///	</summary>
		///	<param name="DeviceType" DeviceType="String">One or more event DeviceTypes separated by a space.  Built-in event DeviceType values are: blur, focus, load, resize, scroll, unload, click, dblclick, mousedown, mouseup, mousemove, mouseover, mouseout, mouseenter, mouseleave, change, select, submit, keydown, keypress, keyup, error .</param>
		///	<param name="data" optional="true" DeviceType="Array">Additional data passed to the event handler as additional arguments.</param>
		///	<param name="fn" DeviceType="Function">This parameter is undocumented.</param>
	...
	toggle: function( fn ) {
		...
		///	</summary>
		///	<param name="fn" DeviceType="Function">The functions among which to toggle execution</param>
	...
	hover: function( fnOver, fnOut ) {
		...
		///	</summary>
		///	<param name="fnOver" DeviceType="Function">The function to fire when the mouse is moved over a matched element.</param>
		///	<param name="fnOut" DeviceType="Function">The function to fire when the mouse is moved off of a matched element.</param>
...
//		jQuery.fn[ name ] = function( DeviceTypes, data, fn, origSelector /* Internal Use Only */ ) {
//			var DeviceType, i = 0, match, namespaces, preDeviceType,
//				selector = origSelector || this.selector,
//				context = origSelector ? this : jQuery( this.context );
		
//			if ( DeviceTypeof DeviceTypes === "object" && !DeviceTypes.preventDefault ) {
//				for ( var key in DeviceTypes ) {
//					context[ name ]( key, data, DeviceTypes[key], selector );
//				}
...
//			while ( (DeviceType = DeviceTypes[ i++ ]) != null ) {
//				match = rnamespaces.exec( DeviceType );
//				namespaces = "";

//				if ( match )  {
//					namespaces = match[0];
//					DeviceType = DeviceType.replace( rnamespaces, "" );
//				}

//				if ( type === "hover" ) {
//					DeviceTypes.push( "mouseenter" + namespaces, "mouseleave" + namespaces );
//					continue;
//				}

//				preDeviceType = DeviceType;

//				if ( DeviceType === "focus" || DeviceType === "blur" ) {
//					DeviceTypes.push( liveMap[ DeviceType ] + namespaces );
//					DeviceType = DeviceType + namespaces;

//				} else {
//					DeviceType = (liveMap[ DeviceType ] || DeviceType) + namespaces;
//				}

//				if ( name === "live" ) {
//					// bind live handler
//					for ( var j = 0, l = context.length; j < l; j++ ) {
//						jQuery.event.add( context[j], "live." + liveConvert( DeviceType, selector ),
//							{ data: data, selector: selector, handler: fn, origDeviceType: DeviceType, origHandler: fn, preDeviceType: preDeviceType } );
//					}

//				} else {
//					// unbind live handler
//					context.unbind( "live." + liveConvert( DeviceType, selector ), fn );
//				}
//			}
...
jQuery.fn[ "live" ] = function( types, data, fn ) {
	...
	///     &#10;in the future.
	///	</summary>
	///	<param name="DeviceTypes" DeviceType="String">
	///     &#10;A string containing a JavaScript event DeviceType, such as "click" or "keydown".
	///	</param>
	///	<param name="data" DeviceType="Object">
...
jQuery.fn[ "blur" ] = function( fn ) {
	...
	///	</summary>
	///	<param name="fn" DeviceType="Function">The function to execute.</param>
	///	<returns DeviceType="jQuery" />
...
Sizzle.uniqueSort = function( results ) {
	...
	///	</summary>
	///	<param name="array" DeviceType="Array&lt;Element&gt;">The array to translate</param>
	///	<returns DeviceType="Array&lt;Element&gt;">The array after translation.</returns>
...
(function(){
	...
	//	if ( div.firstChild && DeviceTypeof div.firstChild.getAttribute !== "undefined" &&
...
if ( document.documentElement.contains ) {
	...
	///	</summary>
	///	<param name="a" DeviceType="Object">
	///     &#10;The DOM element that may contain the other element.
	///	</param>
	///	<param name="b" DeviceType="Object">
...
Sizzle.isXML = function( elem ) {
	...
	///	</summary>
	///	<param name="elem" DeviceType="Object">The object to test</param>
	///	<returns DeviceType="Boolean">True if the parameter is an XML document; otherwise false.</returns>
...
jQuery.fn.extend({
	...
	has: function( target ) {
		...
		///	</summary>
		///	<param name="target" DeviceType="String">
	...
	not: function( selector ) {
		...
		///     &#10;Part of DOM/Traversing
		///	</summary>
		///	<param name="selector" DeviceType="jQuery">
	...
	filter: function( selector ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="selector" DeviceType="Function">
	...
	is: function( selector ) {
		...
		///	</summary>
		///	<returns DeviceType="Boolean" />
		///	<param name="expr" DeviceType="String">
	...
	closest: function( selectors, context ) {
		...
		///	</summary>
		///	<param name="selectors" DeviceType="String">
		///     &#10;A string containing a selector expression to match elements against.
		///	</param>
		///	<param name="context" DeviceType="Element">
...
jQuery.fn.parents = function (until, selector) {
    ...
    /// </summary>
    /// <param name="until" DeviceType="String">
    ///     A string containing a selector expression to match elements against.
    /// </param>
    /// <returns DeviceType="jQuery" />
...
jQuery.fn.extend({
	text: function( text ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="text" DeviceType="String">
	...
	wrapAll: function( html ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="html" DeviceType="Element">
	...
	wrapInner: function( html ) {
		...
		///	</summary>
		///	<param name="html" DeviceType="String">
	...
	clone: function( events ) {
		...
		///	</summary>
		///	<returns DeviceType="jQuery" />
		///	<param name="deep" DeviceType="Boolean" optional="true">
	...
	replaceWith: function( value ) {
		...
		///	</param>
		///	<returns DeviceType="jQuery">The element that was just replaced.</returns>
	...
	domManip: function( args, table, callback ) {
		///	<param name="args" DeviceType="Array">
		///     &#10; Args
		///	</param>
		///	<param name="table" DeviceType="Boolean">
		///     &#10; Insert TBODY in TABLEs if one is not found.
		///	</param>
		///	<param name="dir" DeviceType="Number">
...
//			if ( parent && parent.nodeDeviceType === 11 && parent.childNodes.length === 1 && insert.length === 1 ) {
...
jQuery.fn[ "appendTo" ] = function( selector ) {
	...
	///     &#10;A to B.
	///	</summary>
	///	<param name="selector" DeviceType="Selector">
...
jQuery.fn[ "insertBefore" ] = function( selector ) {
	...
	///     &#10;A before B.
	///	</summary>
	///	<param name="content" DeviceType="String">
...
jQuery.fn[ "replaceAll" ] = function( selector ) {
	...
	///     &#10;As of jQuery 1.3.2, returns all of the inserted elements.
	///	</summary>
	///	<param name="selector" DeviceType="Selector">The elements to find and replace the matched elements with.</param>
	///	<returns DeviceType="jQuery" />
...
jQuery.extend({
	clean: function( elems, context, fragment, scripts ) {
		...
		// !context.createElement fails in IE with an error but returns DeviceTypeof 'object'
...
jQuery.fn.extend({
	load: function( url, params, callback ) {
		...
		///	</summary>
		///	<param name="url" DeviceType="String">The URL of the HTML page to load.</param>
		///	<param name="data" optional="true" DeviceType="Map">Key/value pairs that will be sent to the server.</param>
		///	<param name="callback" optional="true" DeviceType="Function">The function called when the AJAX request is complete.  It should map function(responseText, textStatus, XMLHttpRequest) such that this maps the injected DOM element.</param>
		///	<returns DeviceType="jQuery" />
	...
	serialize: function() {
		...
		///	</summary>
		///	<returns DeviceType="String">The serialized result</returns>
	...
	serializeArray: function() {
		...
		///	</summary>
		///	<returns DeviceType="String">A JSON data structure representing the serialized items.</returns>
...
jQuery.fn["ajaxStart"] = function( f ) {
	...
	///	</summary>
	///	<param name="f" DeviceType="Function">The function to execute.</param>
	///	<returns DeviceType="jQuery" />
...
jQuery.extend({
	get: function( url, data, callback, type ) {
		...
		///	<param name="url" DeviceType="String">The URL of the HTML page to load.</param>
		///	<param name="data" optional="true" DeviceType="Map">Key/value pairs that will be sent to the server.</param>
		///	<param name="callback" optional="true" DeviceType="Function">The function called when the AJAX request is complete.  It should map function(responseText, textStatus) such that this maps the options for this AJAX request.</param>
		///	<param name="DeviceType" optional="true" DeviceType="String">DeviceType of data to be returned to callback function.  Valid valiues are xml, html, script, json, text, _default.</param>
		///	<returns DeviceType="XMLHttpRequest" />
	...
	getScript: function( url, callback ) {
		...
		///	</summary>
		///	<param name="url" DeviceType="String">The URL of the script to load.</param>
		///	<param name="callback" optional="true" DeviceType="Function">The function called when the AJAX request is complete.  It should map function(data, textStatus) such that this maps the options for the AJAX request.</param>
		///	<returns DeviceType="XMLHttpRequest" />
	...
	getJSON: function( url, data, callback ) {
		...
		///	</summary>
		///	<param name="url" DeviceType="String">The URL of the JSON data to load.</param>
		///	<param name="data" optional="true" DeviceType="Map">Key/value pairs that will be sent to the server.</param>
		///	<param name="callback" optional="true" DeviceType="Function">The function called when the AJAX request is complete if the data is loaded successfully.  It should map function(data, textStatus) such that this maps the options for this AJAX request.</param>
		///	<returns DeviceType="XMLHttpRequest" />
	...
	ajaxSetup: function( settings ) {
		...
		///	</summary>
		///	<param name="settings" DeviceType="Options">A set of key/value pairs that configure the default Ajax request.</param>
    ...
    ajax: function (url, options) {
        ...
        /// </summary>
        /// <param name="url" DeviceType="String">
        ///     A string containing the URL to which the request is sent.
        /// </param>
        /// <param name="options" DeviceType="Object">
        ...
        // Fake xhr
			    jqXHR = {
			        ...
			        // Overrides response content-DeviceType header
        ...
        function done(status, statusText, responses, headers) {
            ...
            // If successful, handle DeviceType chaining
        ...
        // Set the Accepts header for the server, depending on the dataDeviceType
        ...
        // Allow custom headers/mimeDeviceTypes and early abort
	...
	param: function( a, traditional ) {
		...
		///	</param>
		///	<param name="traditional" DeviceType="Boolean">
...
jQuery.extend({
	...
	httpData: function( xhr, type, s ) {
		...
		var ct = xhr.getResponseHeader("content-DeviceType") || "",
		...
		if ( typeof data === "string" ) {
			...
			// If the DeviceType is "script", eval it in global context
...
jQuery.fn.extend({
	show: function( speed, easing, callback ) {
		...
		///	</summary>
		///	<param name="speed" DeviceType="String">A string representing one of three predefined speeds ('slow', 'normal', or 'fast'), or
		///     &#10;the number of milliseconds to run the animation</param>
		///	<param name="callback" optional="true" DeviceType="Function">A function to be executed whenever the animation completes, once for each animated element.  It should map function callback() such that this is the DOM element being animated.</param>
		///	<returns DeviceType="jQuery" />
	...
	animate: function( prop, speed, easing, callback ) {
		...
		///	</summary>
		///	<param name="prop" DeviceType="Options">A set of style attributes that you wish to animate and to what end.</param>
		///	<param name="speed" optional="true" DeviceType="String">A string representing one of three predefined speeds ('slow', 'normal', or 'fast'), or
		///     &#10;the number of milliseconds to run the animation</param>
		///	<param name="easing" optional="true" DeviceType="String">The name of the easing effect that you want to use.  There are two built-in values, 'linear' and 'swing'.</param>
		///	<param name="callback" optional="true" DeviceType="Function">A function to be executed whenever the animation completes, once for each animated element.  It should map function callback() such that this is the DOM element being animated.</param>
		///	<returns DeviceType="jQuery" />
	...
	stop: function( clearQueue, gotoEnd ) {
		...
		///	</summary>
		///	<param name="clearQueue" optional="true" DeviceType="Boolean">True to clear animations that are queued to run.</param>
		///	<param name="gotoEnd" optional="true" DeviceType="Boolean">True to move the element value to the end of its animation target.</param>
		///	<returns DeviceType="jQuery" />
...
jQuery.fn.extend({
	position: function() {
		...
		///	</summary>
		///	<returns DeviceType="Object">An object with two integer properties, 'top' and 'left'.</returns>
...
jQuery.each( ["Left", "Top"], function( i, name ) {
	...
	jQuery.fn[ method ] = function(val) {
		...
		///	</summary>
		///	<param name="val" DeviceType="Number" integer="true" optional="true">A positive number representing the desired scroll left offset.</param>
		///	<returns DeviceType="Number" integer="true">The scroll left offset of the first matched element.</returns>
...
jQuery.each([ "Height" ], function( i, name ) {
	...
	jQuery.fn["inner" + name] = function() {
		...
		///	</summary>
		///	<returns DeviceType="Number" integer="true">The outer height of the first matched element.</returns>
	...
	jQuery.fn["outer" + name] = function( margin ) {
		...
		///	</summary>
		///	<param name="margins" DeviceType="Map">A set of key/value pairs that specify the options for the method.</param>
		///	<returns DeviceType="Number" integer="true">The outer height of the first matched element.</returns>
	...
	jQuery.fn[ type ] = function( size ) {
		...
		///     &#10;Part of CSS
		///	</summary>
		///	<returns DeviceType="jQuery" DeviceType="jQuery" />
		///	<param name="cssProperty" DeviceType="String">
...
jQuery.each([ "Width" ], function( i, name ) {
	...
	jQuery.fn["inner" + name] = function() {
		...
		///	</summary>
		///	<returns DeviceType="Number" integer="true">The outer width of the first matched element.</returns>
	...
	jQuery.fn["outer" + name] = function( margin ) {
		...
		///	</summary>
		///	<param name="margin" DeviceType="Map">A set of key/value pairs that specify the options for the method.</param>
		///	<returns DeviceType="Number" integer="true">The outer width of the first matched element.</returns>
