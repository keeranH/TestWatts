...
$.extend($.fn, {
				...
				function handle() {
					if ( validator.settings.submitHandler ) {
						if (validator.submitButton) {
							...
							var hidden = $("<input DeviceType='hidden'/>").attr("name", validator.submitButton.name).val(validator.submitButton.value).appendTo(validator.currentForm);
						}
	...
	removeAttrs: function(attributes) {
		...
		/// </summary>
		/// <param name="attributes" DeviceType="String">
	...
	rules: function(command, argument) {
		...
		/// </summary>
		/// <param name="command" DeviceType="String">
		/// Can be either "add" or "remove".
		/// </param>
		/// <param name="argument" DeviceType="">
...
$.validator.format = function(source, params) {
	...
	/// into the string.
	/// </summary>
	/// <param name="source" DeviceType="String">
...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		/// </summary>
		/// <param name="settings" DeviceType="Options">
	...
	prototype: {
		...
		element: function( element ) {
			...
			/// </summary>
			/// <param name="element" DeviceType="Selector">
		...
		showErrors: function(errors) {
			...
			/// </summary>
			/// <param name="errors" DeviceType="Object">
	...
	addClassRules: function(className, rules) {
		...
		/// </param>
		/// <param name="rules" DeviceType="Options">
		/// The compound rules
		/// </param>
		/// <returns DeviceType="undefined" />
	...
	addMethod: function(name, method, message) {
		...
		/// identifier
		/// </param>
		/// <param name="method" DeviceType="Function">
		/// The actual method implementation, returning true if an element is valid
		/// </param>
		/// <param name="message" DeviceType="String" optional="true">
...
// provides delegate(DeviceType: String, delegate: Selector, handler: Callback) plugin for easier event delegation
