...
Sys.Mvc.NumberValidator.create = function Sys_Mvc_NumberValidator$create(rule) {
    /// <param name="rule" DeviceType="Sys.Mvc.JsonValidationRule">
    /// </param>
    /// <returns DeviceType="Sys.Mvc.Validator"></returns>
...
Sys.Mvc.NumberValidator.prototype = {
    ...
    validate: function Sys_Mvc_NumberValidator$validate(value, context) {
        ...
        /// </param>
        /// <param name="context" DeviceType="Sys.Mvc.ValidationContext">
        /// </param>
...
Sys.Mvc.FormContext = function Sys_Mvc_FormContext(formElement, validationSummaryElement) {
    /// <param name="formElement" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="validationSummaryElement" DeviceType="Object" domElement="true">
    /// </param>
    /// <field name="_validationSummaryErrorCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_validationSummaryValidCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_formValidationTag" DeviceType="String" static="true">
    /// </field>
    /// <field name="_onClickHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_onSubmitHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_errors" DeviceType="Array">
    /// </field>
    /// <field name="_submitButtonClicked" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="_validationSummaryElement" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="_validationSummaryULElement" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="fields" DeviceType="Array" elementDeviceType="FieldContext">
    /// </field>
    /// <field name="_formElement" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="replaceValidationSummary" DeviceType="Boolean">
    /// </field>
    this._errors = [];
...
Sys.Mvc.FormContext._getFormElementsWithName = function Sys_Mvc_FormContext$_getFormElementsWithName(formElement, name) {
    ...
    /// </param>
    /// <returns DeviceType="Array" elementDeviceType="Object" elementDomElement="true"></returns>
...
Sys.Mvc.FormContext.getValidationForForm = function Sys_Mvc_FormContext$getValidationForForm(formElement) {
    /// <param name="formElement" DeviceType="Object" domElement="true">
    /// </param>
    /// <returns DeviceType="Sys.Mvc.FormContext"></returns>
...
Sys.Mvc.FormContext._isElementInHierarchy = function Sys_Mvc_FormContext$_isElementInHierarchy(parent, child) {
    /// <param name="parent" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="child" DeviceType="Object" domElement="true">
    /// </param>
...
Sys.Mvc.FormContext._parseJsonOptions = function Sys_Mvc_FormContext$_parseJsonOptions(options) {
    /// <param name="options" DeviceType="Sys.Mvc.JsonValidationOptions">
    /// </param>
    /// <returns DeviceType="Sys.Mvc.FormContext"></returns>
...
Sys.Mvc.FormContext.prototype = {
    ...
    addError: function Sys_Mvc_FormContext$addError(message) {
        /// <param name="message" DeviceType="String">
        /// </param>
        this.addErrors([ message ]);
    },
    
    addErrors: function Sys_Mvc_FormContext$addErrors(messages) {
        /// <param name="messages" DeviceType="Array" elementDeviceType="String">
        /// </param>
    ...
    _findSubmitButton: function Sys_Mvc_FormContext$_findSubmitButton(element) {
        /// <param name="element" DeviceType="Object" domElement="true">
        /// </param>
        /// <returns DeviceType="Object" domElement="true"></returns>
        if (element.disabled) {
            return null;
        }
    ...
    _form_OnClick: function Sys_Mvc_FormContext$_form_OnClick(e) {
        /// <param name="e" DeviceType="Sys.UI.DomEvent">
        /// </param>
    ...
    validate: function Sys_Mvc_FormContext$validate(eventName) {
        /// <param name="eventName" DeviceType="String">
        /// </param>
        /// <returns DeviceType="Array" elementDeviceType="String"></returns>
...
Sys.Mvc.FieldContext = function Sys_Mvc_FieldContext(formContext) {
    /// <param name="formContext" DeviceType="Sys.Mvc.FormContext">
    /// </param>
    /// <field name="_hasTextChangedTag" DeviceType="String" static="true">
    /// </field>
    /// <field name="_hasValidationFiredTag" DeviceType="String" static="true">
    /// </field>
    /// <field name="_inputElementErrorCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_inputElementValidCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_validationMessageErrorCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_validationMessageValidCss" DeviceType="String" static="true">
    /// </field>
    /// <field name="_onBlurHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_onChangeHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_onInputHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_onPropertyChangeHandler" DeviceType="Sys.UI.DomEventHandler">
    /// </field>
    /// <field name="_errors" DeviceType="Array">
    /// </field>
    /// <field name="defaultErrorMessage" DeviceType="String">
    /// </field>
    /// <field name="elements" DeviceType="Array" elementDeviceType="Object" elementDomElement="true">
    /// </field>
    /// <field name="formContext" DeviceType="Sys.Mvc.FormContext">
    /// </field>
    /// <field name="replaceValidationMessageContents" DeviceType="Boolean">
    /// </field>
    /// <field name="validationMessageElement" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="validations" DeviceType="Array" elementDeviceType="Validation">
    /// </field>
    this._errors = [];
...
Sys.Mvc.FieldContext.prototype = {
    ...
    _getErrorString: function Sys_Mvc_FieldContext$_getErrorString(validatorReturnValue, fieldErrorMessage) {
        /// <param name="validatorReturnValue" DeviceType="Object">
        /// </param>
        /// <param name="fieldErrorMessage" DeviceType="String">
        /// </param>
...
Sys.Mvc.RangeValidator = function Sys_Mvc_RangeValidator(minimum, maximum) {
    /// <param name="minimum" DeviceType="Number">
    /// </param>
    /// <param name="maximum" DeviceType="Number">
    /// </param>
    /// <field name="_minimum" DeviceType="Number">
    /// </field>
    /// <field name="_maximum" DeviceType="Number">
    /// </field>
...
Sys.Mvc.RegularExpressionValidator = function Sys_Mvc_RegularExpressionValidator(pattern) {
    /// <param name="pattern" DeviceType="String">
    /// </param>
    /// <field name="_pattern" DeviceType="String">
    /// </field>
...
Sys.Mvc.RequiredValidator._validateRadioInput = function Sys_Mvc_RequiredValidator$_validateRadioInput(elements) {
    /// <param name="elements" DeviceType="Array" elementDeviceType="Object" elementDomElement="true">
    /// </param>
    /// <returns DeviceType="Object"></returns>
    for (var i = 0; i < elements.length; i++) {
        var element = elements[i];
...
Sys.Mvc.RequiredValidator._validateSelectInput = function Sys_Mvc_RequiredValidator$_validateSelectInput(optionElements) {
    /// <param name="optionElements" DeviceType="DOMElementCollection">
    /// </param>
    /// <returns DeviceType="Object"></returns>
...
Sys.Mvc.StringLengthValidator = function Sys_Mvc_StringLengthValidator(minLength, maxLength) {
    /// <param name="minLength" DeviceType="Number" integer="true">
    /// </param>
    /// <param name="maxLength" DeviceType="Number" integer="true">
    /// </param>
    /// <field name="_maxLength" DeviceType="Number" integer="true">
    /// </field>
    /// <field name="_minLength" DeviceType="Number" integer="true">
    /// </field>
...
Sys.Mvc._validationUtil.arrayIsNullOrEmpty = function Sys_Mvc__validationUtil$arrayIsNullOrEmpty(array) {
    /// <param name="array" DeviceType="Array" elementDeviceType="Object">
    /// </param>
    /// <returns DeviceType="Boolean"></returns>
...
Sys.Mvc._validationUtil.elementSupportsEvent = function Sys_Mvc__validationUtil$elementSupportsEvent(element, eventAttributeName) {
    /// <param name="element" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="eventAttributeName" DeviceType="String">
    /// </param>
    /// <returns DeviceType="Boolean"></returns>
...
Sys.Mvc._validationUtil.setInnerText = function Sys_Mvc__validationUtil$setInnerText(element, innerText) {
    /// <param name="element" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="innerText" DeviceType="String">
    /// </param>
...
Sys.Mvc.ValidatorRegistry = function Sys_Mvc_ValidatorRegistry() {
    /// <field name="validators" DeviceType="Object" static="true">
    /// </field>
}
