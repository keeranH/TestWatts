...
Sys.Mvc.InsertionMode = function() { 
    /// <field name="replace" DeviceType="Number" integer="true" static="true">
    /// </field>
    /// <field name="insertBefore" DeviceType="Number" integer="true" static="true">
    /// </field>
    /// <field name="insertAfter" DeviceType="Number" integer="true" static="true">
    /// </field>
};
...
Sys.Mvc.AjaxContext = function Sys_Mvc_AjaxContext(request, updateTarget, loadingElement, insertionMode) {
    /// <param name="request" DeviceType="Sys.Net.WebRequest">
    /// </param>
    /// <param name="updateTarget" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="loadingElement" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="insertionMode" DeviceType="Sys.Mvc.InsertionMode">
    /// </param>
    /// <field name="_insertionMode" DeviceType="Sys.Mvc.InsertionMode">
    /// </field>
    /// <field name="_loadingElement" DeviceType="Object" domElement="true">
    /// </field>
    /// <field name="_response" DeviceType="Sys.Net.WebRequestExecutor">
    /// </field>
    /// <field name="_request" DeviceType="Sys.Net.WebRequest">
    /// </field>
    /// <field name="_updateTarget" DeviceType="Object" domElement="true">
    /// </field>
...
Sys.Mvc.AjaxContext.prototype = {
    ...
    get_response: function Sys_Mvc_AjaxContext$get_response() {
        /// <value DeviceType="Sys.Net.WebRequestExecutor"></value>
    ...
    get_request: function Sys_Mvc_AjaxContext$get_request() {
        /// <value DeviceType="Sys.Net.WebRequest"></value>
...
Sys.Mvc.AsyncHyperlink.handleClick = function Sys_Mvc_AsyncHyperlink$handleClick(anchor, evt, ajaxOptions) {
    /// <param name="anchor" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="evt" DeviceType="Sys.UI.DomEvent">
    /// </param>
    /// <param name="ajaxOptions" DeviceType="Sys.Mvc.AjaxOptions">
    /// </param>
    evt.preventDefault();
...
Sys.Mvc.MvcHelpers._serializeSubmitButton = function Sys_Mvc_MvcHelpers$_serializeSubmitButton(element, offsetX, offsetY) {
    ...
    /// </param>
    /// <param name="offsetX" DeviceType="Number" integer="true">
    /// </param>
    /// <param name="offsetY" DeviceType="Number" integer="true">
    /// </param>
...
Sys.Mvc.MvcHelpers._serializeForm = function Sys_Mvc_MvcHelpers$_serializeForm(form) {
    /// <param name="form" DeviceType="Object" domElement="true">
    /// </param>
    /// <returns DeviceType="String"></returns>
...
Sys.Mvc.MvcHelpers._asyncRequest = function Sys_Mvc_MvcHelpers$_asyncRequest(url, verb, body, triggerElement, ajaxOptions) {
    ...
    /// </param>
    /// <param name="verb" DeviceType="String">
    /// </param>
    /// <param name="body" DeviceType="String">
    /// </param>
    /// <param name="triggerElement" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="ajaxOptions" DeviceType="Sys.Mvc.AjaxOptions">
    /// </param>
...
Sys.Mvc.MvcHelpers._onComplete = function Sys_Mvc_MvcHelpers$_onComplete(request, ajaxOptions, ajaxContext) {
    ...
    /// <param name="ajaxOptions" DeviceType="Sys.Mvc.AjaxOptions">
    /// </param>
    /// <param name="ajaxContext" DeviceType="Sys.Mvc.AjaxContext">
    /// </param>
    ...
    if ((statusCode >= 200 && statusCode < 300) || statusCode === 304 || statusCode === 1223) {
        if (statusCode !== 204 && statusCode !== 304 && statusCode !== 1223) {
            var contentType = ajaxContext.get_response().getResponseHeader('Content-DeviceType');
...
Sys.Mvc.MvcHelpers.updateDomElement = function Sys_Mvc_MvcHelpers$updateDomElement(target, insertionMode, content) {
    /// <param name="target" DeviceType="Object" domElement="true">
    /// </param>
    /// <param name="insertionMode" DeviceType="Sys.Mvc.InsertionMode">
    /// </param>
