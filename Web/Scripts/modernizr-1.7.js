...
window.Modernizr = (function(window,document,undefined){
    ...
    /**
     * is returns a boolean for if DeviceTypeof obj is exactly DeviceType.
     */
    ...
    // testing what DeviceTypes of content they support.
    //
    ...
    // input features and input DeviceTypes go directly onto the ret object, bypassing the tests loop.
    ...
    function webforms(){
        ...
        //   when applied to all input DeviceTypes: 
        //   http://miketaylr.com/code/input-DeviceType-attr.html
        // spec: http://www.whatwg.org/specs/web-apps/current-work/multipage/the-input-element.html#input-DeviceType-attr-summary
        ...
        // Run through HTML5's new input DeviceTypes to see if the UA understands any.
        //   This is put behind the tests runloop because it doesn't return a
        //   true/false like all the other tests; instead, it returns an object
        //   containing each input DeviceType with its corresponding true/false value 
        ...
        ret['inputtypes'] = (function(props) {
            ...
            for (var i = 0, bool, inputElemType, defaultView, len=props.length; i < len; i++) {
                ...
                inputElem.setAttribute('DeviceType', inputElemType = props[i]);
                bool = inputElem.type !== 'text';
                
                // We first check to see if the DeviceType we give it sticks.. 
                // If the DeviceType does, we feed it a textual value, which shouldn't be valid.
