...
$.widget = function( name, base, prototype ) {
	...
	// otherwise we'll modify the options hash on the protoDeviceType that we're
	// inheriting from
//	$.each( baseProtoDeviceType, function( key, val ) {
//		if ( $.isPlainObject(val) ) {
//			baseProtoDeviceType[ key ] = $.extend( {}, val );
//		}
//	});
...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_create: function() {
		...
		this._renderAxis = function(target) {
			...
			for(var i in this.handles) {
				...
				if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
					...
					//The padding DeviceType i have to apply...
					var padPos = [ 'padding',
						/ne|nw|n/.test(i) ? 'Top' :
		...
		//TODO: make renderAxis a protoDeviceType function
...
$.widget( "ui.button", {
	...
	_create: function() {
		...
		// $.Widget.protoDeviceType._setOptionDisabled so it's easy to proxy and can
...
$.widget("ui.dialog", {
		...
		if (hasButtons) {
			$.each(buttons, function(name, props) {
				props = $.isFunction( props ) ?
					...
					props;
				var button = $('<button DeviceType="button"></button>')
					.attr( props, true )
					.unbind('click')
					.click(function() {
	...
	//		if (DeviceTypeof position == 'string' || $.isArray(position)) {
...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(input, inst) {
		...
		if (showOn == 'button' || showOn == 'both') { // pop-up date picker when button clicked
			...
			inst.trigger = $(this._get(inst, 'buttonImageOnly') ?
				...
				$('<button DeviceType="button"></button>').addClass(this._triggerClass).
	...
	_dialogDatepicker: function(input, date, onSelect, settings, pos) {
		...
		if (!inst) {
			this.uuid += 1;
			var id = 'dp' + this.uuid;
			this._dialogInput = $('<input DeviceType="text" id="' + id +
	...
	_generateHTML: function(inst) {
		...
		var controls = (!inst.inline ? '<button DeviceType="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_' + dpuuid +
			'.datepicker._hideDatepicker();">' + this._get(inst, 'closeText') + '</button>' : '');
		var buttonPanel = (showButtonPanel) ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (isRTL ? controls : '') +
			(this._isInRange(inst, gotoDate) ? '<button DeviceType="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_' + dpuuid +
