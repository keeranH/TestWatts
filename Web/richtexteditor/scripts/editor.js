...
$rte.Editor=$rte.Core._extends(function(base,type){
	...
	this._toggleFullScreen=function()
	{
		...
		else
		{
			...
			ctrl.set_width(div.clientWidth);
			ctrl.set_height(div.clientHeight);
	...
	this.RemoveInnerLink=function(node)
	{
		var index=0;
		while(true)
		{
	...
	this.ExecInsertTemplate=function(anchor)
	{
		...
		this.ShowXmlDialog(this.BuildDialogUrl("inserttemplate.xml"),option);
	}
